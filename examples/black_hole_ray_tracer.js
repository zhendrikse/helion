import{Ct as e,Ot as t,xt as n,yt as r}from"../assets/src-DCXULflv.js";import{A as i,G as a,L as o,O as s,X as c,Z as l}from"../assets/fresnel_fragment_shader-C6hldLup.js";var u=`varying vec2 vUv;
...
`,f=class extends r{constructor({width:e=160,height:t=90,cameraPosition:n=new l(0,0,-8),blackHolePosition:r=new l(0,0,0),rotation:i=new l(s.degToRad(-4),0,s.degToRad(-15))}={}){super(),this._uniforms={uResolution:{value:new c(e,t)},uTime:{value:0},uCamPos:{value:n},uBlackHolePos:{value:r},uRotation:{value:i}}}get uniforms(){return this._uniforms}},p=class extends t{constructor({aspectRatio:e=e}={}){super(),this._canvasGeometry=new o(e,1)}initialize(e){let t=new a({uniforms:e.uniforms,vertexShader:u,fragmentShader:d}),n=new i(this._canvasGeometry,t);this.add(n)}canBindTo(e){return e.uniforms}},m=n.with({htmlDivId:`blackHoleRayTraceContainer`,cameraPosition:new l(0,0,.8),fieldOfView:75}),h=m._viewport.width,g=m._viewport.height,_=new p({aspectRatio:h/g}),v=new f({width:h,height:g}),y=!0;m.bind(v.alwaysWith(_)).onFrame(e=>{y&&(v.uniforms.uTime.value=e*.001)}).append(new e(`Animate `).checked(!0).addEventListener(`change`,()=>y=!y)).start();