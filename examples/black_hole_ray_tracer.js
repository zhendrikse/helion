import{Nn as e,Sn as t,Tn as n,bn as r}from"../assets/src-KkHB7FXj.js";import{I as i,K as a,R as o,ct as s,et as c,st as l}from"../assets/fresnel_fragment_shader-B0pV0CFP.js";var u=`varying vec2 vUv;
...
`,f=class extends r{constructor({width:e=160,height:t=90,cameraPosition:n=new s(0,0,-8.5),blackHolePosition:r=new s(0,0,0),rotation:a=new s(i.degToRad(-4),0,i.degToRad(-15))}={}){super(),this._uniforms={uResolution:{value:new l(e,t)},uTime:{value:0},uCamPos:{value:n},uBlackHolePos:{value:r},uRotation:{value:a}}}get uniforms(){return this._uniforms}},p=class extends e{constructor({aspectRatio:e=e}={}){super(),this._canvasGeometry=new a(e,1)}initialize(e){let t=new c({uniforms:e.uniforms,vertexShader:u,fragmentShader:d}),n=new o(this._canvasGeometry,t);this.add(n)}canBindTo(e){return e.uniforms}},m=t.with({htmlDivId:`blackHoleRayTraceContainer`,camera:{position:new s(0,0,.6),fieldOfView:75},viewport:{aspectRatio:`16/9`}}),h=new p({aspectRatio:m.width/m.height}),g=new f({width:m.width,height:m.height}),_=!0;m.bind(g.alwaysWith(h)).onFrame(e=>{_&&(g.uniforms.uTime.value=e*.001)}).append(new n(`Animate `).checked(!0).addEventListener(`change`,()=>_=!_)).start();