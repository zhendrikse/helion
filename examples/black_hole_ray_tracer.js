import{At as e,Dt as t,Pt as n,Tt as r}from"../assets/src-BupUIRuV.js";import{D as i,I as a,W as o,X as s,Y as c,k as l}from"../assets/OrbitControls-zcd7Z0hU.js";var u=`varying vec2 vUv;
...
`,f=class extends r{constructor({width:e=160,height:t=90,cameraPosition:n=new s(0,0,-8.5),blackHolePosition:r=new s(0,0,0),rotation:a=new s(i.degToRad(-4),0,i.degToRad(-15))}={}){super(),this._uniforms={uResolution:{value:new c(e,t)},uTime:{value:0},uCamPos:{value:n},uBlackHolePos:{value:r},uRotation:{value:a}}}get uniforms(){return this._uniforms}},p=class extends n{constructor({aspectRatio:e=e}={}){super(),this._canvasGeometry=new a(e,1)}initialize(e){let t=new o({uniforms:e.uniforms,vertexShader:u,fragmentShader:d}),n=new l(this._canvasGeometry,t);this.add(n)}canBindTo(e){return e.uniforms}},m=t.with({htmlDivId:`blackHoleRayTraceContainer`,cameraPosition:new s(0,0,.6),fieldOfView:75}),h=m._viewport.width,g=m._viewport.height,_=new p({aspectRatio:h/g}),v=new f({width:h,height:g}),y=!0;m.bind(v.alwaysWith(_)).onFrame(e=>{y&&(v.uniforms.uTime.value=e*.001)}).append(new e(`Animate `).checked(!0).addEventListener(`change`,()=>y=!y)).start();