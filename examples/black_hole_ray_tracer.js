import{Qt as e,Yt as t,qt as n,rn as r}from"../assets/src-BtYGL5hb.js";import{I as i,P as a,U as o,Z as s,at as c,it as l}from"../assets/OrbitControls-Cf9SQYCz.js";var u=`varying vec2 vUv;
...
`,f=class extends n{constructor({width:e=160,height:t=90,cameraPosition:n=new c(0,0,-8.5),blackHolePosition:r=new c(0,0,0),rotation:i=new c(a.degToRad(-4),0,a.degToRad(-15))}={}){super(),this._uniforms={uResolution:{value:new l(e,t)},uTime:{value:0},uCamPos:{value:n},uBlackHolePos:{value:r},uRotation:{value:i}}}get uniforms(){return this._uniforms}},p=class extends r{constructor({aspectRatio:e=e}={}){super(),this._canvasGeometry=new o(e,1)}initialize(e){let t=new s({uniforms:e.uniforms,vertexShader:u,fragmentShader:d}),n=new i(this._canvasGeometry,t);this.add(n)}canBindTo(e){return e.uniforms}},m=t.with({htmlDivId:`blackHoleRayTraceContainer`,camera:{position:new c(0,0,.6),fieldOfView:75},viewport:{aspectRatio:`16/9`}}),h=new p({aspectRatio:m.width/m.height}),g=new f({width:m.width,height:m.height}),_=!0;m.bind(g.alwaysWith(h)).onFrame(e=>{_&&(g.uniforms.uTime.value=e*.001)}).append(new e(`Animate `).checked(!0).addEventListener(`change`,()=>_=!_)).start();