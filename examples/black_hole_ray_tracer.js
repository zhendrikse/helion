import{Tn as e,_n as t,bn as n,hn as r}from"../assets/src-DTRKgV0A.js";import{$ as i,F as a,G as o,L as s,ot as c,st as l}from"../assets/fresnel_fragment_shader-C5WOpnXH.js";var u=`varying vec2 vUv;
...
`,f=class extends r{constructor({width:e=160,height:t=90,cameraPosition:n=new l(0,0,-8.5),blackHolePosition:r=new l(0,0,0),rotation:i=new l(a.degToRad(-4),0,a.degToRad(-15))}={}){super(),this._uniforms={uResolution:{value:new c(e,t)},uTime:{value:0},uCamPos:{value:n},uBlackHolePos:{value:r},uRotation:{value:i}}}get uniforms(){return this._uniforms}},p=class extends e{constructor({aspectRatio:e=e}={}){super(),this._canvasGeometry=new o(e,1)}initialize(e){let t=new i({uniforms:e.uniforms,vertexShader:u,fragmentShader:d}),n=new s(this._canvasGeometry,t);this.add(n)}canBindTo(e){return e.uniforms}},m=t.with({htmlDivId:`blackHoleRayTraceContainer`,camera:{position:new l(0,0,.6),fieldOfView:75},viewport:{aspectRatio:`16/9`}}),h=new p({aspectRatio:m.width/m.height}),g=new f({width:m.width,height:m.height}),_=!0;m.bind(g.alwaysWith(h)).onFrame(e=>{_&&(g.uniforms.uTime.value=e*.001)}).append(new n(`Animate `).checked(!0).addEventListener(`change`,()=>_=!_)).start();