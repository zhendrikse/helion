import{$ as e,C as t,H as n,I as r,L as i,R as a,V as o,W as s,X as c,Z as l,at as u,et as d,i as f,t as p}from"../assets/OrbitControls-Cf9SQYCz.js";import{t as m}from"../assets/fresnel_fragment_shader-rKZmwurF.js";var h=`varying vec2 vUv;
...
}`,y=`/helion/assets/Solarsystemscope_texture_2k_earth_daymap-DKLT2WuX.jpg`,b=`/helion/assets/Solarsystemscope_texture_2k_earth_nightmap-BBH1PX2h.jpg`,x=`/helion/assets/earthspec1k-DVJhpabx.jpg`,S=`/helion/assets/Earth-clouds-VLfYlTHa.png`,C=`/helion/assets/2k_earth_normal_map-F-0Z3WD3.png`,w=`/helion/assets/moonmap1k-DNk7Ihgk.jpg`,T=document.getElementById(`earthContainer`),E=document.createElement(`canvas`);E.class=`applicationCanvas`,T.appendChild(E);var D=new f({alpha:!0,canvas:E,antialias:!0});D.shadowMap.enabled=!0,D.shadowMap.type=1,D.setSize(T.clientWidth,T.clientHeight);var O=new n(75,T.clientWidth/T.clientHeight,.1,1e3);O.position.set(0,0,5);var k=new i({color:16755200,opacity:0,transparent:!0}),A=new r(new e(1,30,30),k),j=class n extends t{static loader=new d;static material=new l({uniforms:{u_dayTexture:{value:n.loader.load(y)},u_nightTexture:{value:n.loader.load(b)},u_normalTexture:{value:n.loader.load(C)},u_specTexture:{value:n.loader.load(x)},u_cloudTexture:{value:n.loader.load(S)},u_normalPower:{value:5},u_sunRelPosition:{value:new u(0,0,0)},u_position:{value:new u(0,0,0)},u_moonPosition:{value:new u(0,0,0)},u_moonRadius:{value:.05},u_sunRadius:{value:.2}},vertexShader:h,fragmentShader:g});static atmosphereMaterial=new l({uniforms:{u_sunRelPosition:{value:new u(0,0,0)},u_color:{value:new u(.45,.55,1)}},vertexShader:_,fragmentShader:v,transparent:!0,side:1,depthTest:!0,depthWrite:!1});static fresnelMaterial=new l({uniforms:{u_sunRelPosition:{value:new u(0,0,0)},u_color:{value:new u(.45,.55,1)}},vertexShader:_,fragmentShader:m,transparent:!0});constructor(){super();let t=new e(1,30,30);t.computeTangents();let i=new r(t,n.material);i.scale.set(.2,.2,.2);let a=new r(t,n.atmosphereMaterial);a.scale.set(1.05,1.05,1.05);let o=new r(t,n.fresnelMaterial);o.scale.set(1.0001,1.0001,1.0001),i.add(a,o),this.add(i)}},M=new a,N=new r(new e(1,30,30),M);N.scale.set(.05,.05,.05),new d().load(w,e=>{M.map=e,M.needsUpdate=!0});var P=new s(16777215,15);P.position.set(0,0,0),P.castShadow=!0;var F=new o,I=new o,L=new o,R=new c,z=new j;R.add(z),R.add(A),A.add(P),R.add(F),F.add(I),I.add(L),L.add(N);var B=new p(O,E);B.enableDamping=!0,O.position.set(0,0,.6);var V=.5,H=0,U=0;function W(e){N.position.set(.4*Math.cos(V*e),0,-.4*Math.sin(V*e)),A.position.set(3*Math.cos(H*e),0,-3*Math.sin(H*e)),j.material.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.material.uniforms.u_sunRelPosition.value.y=0,j.material.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),j.material.uniforms.u_moonPosition.value.x=.4*Math.cos(V*e),j.material.uniforms.u_moonPosition.value.y=0,j.material.uniforms.u_moonPosition.value.z=-.4*Math.sin(V*e),j.atmosphereMaterial.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.atmosphereMaterial.uniforms.u_sunRelPosition.value.y=0,j.atmosphereMaterial.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),j.fresnelMaterial.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.fresnelMaterial.uniforms.u_sunRelPosition.value.y=0,j.fresnelMaterial.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),A.rotateY(U)}function G(e){requestAnimationFrame(G),W(e*.001),B.update(),D.render(R,O)}G();