import{$ as e,B as t,G as n,R as r,T as i,U as a,a as o,ct as s,et as c,n as l,nt as u,q as d,rt as f,t as p,z as m}from"../assets/fresnel_fragment_shader-B0pV0CFP.js";var h=`varying vec2 vUv;
...
}`,y=`/helion/assets/Solarsystemscope_texture_2k_earth_daymap-DKLT2WuX.jpg`,b=`/helion/assets/Solarsystemscope_texture_2k_earth_nightmap-BBH1PX2h.jpg`,x=`/helion/assets/earthspec1k-DVJhpabx.jpg`,S=`/helion/assets/Earth-clouds-VLfYlTHa.png`,C=`/helion/assets/2k_earth_normal_map-F-0Z3WD3.png`,w=`/helion/assets/moonmap1k-DNk7Ihgk.jpg`,T=document.getElementById(`earthContainer`),E=document.createElement(`canvas`);E.class=`applicationCanvas`,T.appendChild(E);var D=new o({alpha:!0,canvas:E,antialias:!0});D.shadowMap.enabled=!0,D.shadowMap.type=1,D.setSize(T.clientWidth,T.clientHeight);var O=new n(75,T.clientWidth/T.clientHeight,.1,1e3);O.position.set(0,0,5);var k=new m({color:16755200,opacity:0,transparent:!0}),A=new r(new u(1,30,30),k),j=class e extends i{static loader=new f;static material=new c({uniforms:{u_dayTexture:{value:e.loader.load(y)},u_nightTexture:{value:e.loader.load(b)},u_normalTexture:{value:e.loader.load(C)},u_specTexture:{value:e.loader.load(x)},u_cloudTexture:{value:e.loader.load(S)},u_normalPower:{value:5},u_sunRelPosition:{value:new s(0,0,0)},u_position:{value:new s(0,0,0)},u_moonPosition:{value:new s(0,0,0)},u_moonRadius:{value:.05},u_sunRadius:{value:.2}},vertexShader:h,fragmentShader:g});static atmosphereMaterial=new c({uniforms:{u_sunRelPosition:{value:new s(0,0,0)},u_color:{value:new s(.45,.55,1)}},vertexShader:_,fragmentShader:v,transparent:!0,side:1,depthTest:!0,depthWrite:!1});static fresnelMaterial=new c({uniforms:{u_sunRelPosition:{value:new s(0,0,0)},u_color:{value:new s(.45,.55,1)}},vertexShader:_,fragmentShader:p,transparent:!0});constructor(){super();let t=new u(1,30,30);t.computeTangents();let n=new r(t,e.material);n.scale.set(.2,.2,.2);let i=new r(t,e.atmosphereMaterial);i.scale.set(1.05,1.05,1.05);let a=new r(t,e.fresnelMaterial);a.scale.set(1.0001,1.0001,1.0001),n.add(i,a),this.add(n)}},M=new t,N=new r(new u(1,30,30),M);N.scale.set(.05,.05,.05),new f().load(w,e=>{M.map=e,M.needsUpdate=!0});var P=new d(16777215,15);P.position.set(0,0,0),P.castShadow=!0;var F=new a,I=new a,L=new a,R=new e,z=new j;R.add(z),R.add(A),A.add(P),R.add(F),F.add(I),I.add(L),L.add(N);var B=new l(O,E);B.enableDamping=!0,O.position.set(0,0,.6);var V=.5,H=0,U=0;function W(e){N.position.set(.4*Math.cos(V*e),0,-.4*Math.sin(V*e)),A.position.set(3*Math.cos(H*e),0,-3*Math.sin(H*e)),j.material.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.material.uniforms.u_sunRelPosition.value.y=0,j.material.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),j.material.uniforms.u_moonPosition.value.x=.4*Math.cos(V*e),j.material.uniforms.u_moonPosition.value.y=0,j.material.uniforms.u_moonPosition.value.z=-.4*Math.sin(V*e),j.atmosphereMaterial.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.atmosphereMaterial.uniforms.u_sunRelPosition.value.y=0,j.atmosphereMaterial.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),j.fresnelMaterial.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.fresnelMaterial.uniforms.u_sunRelPosition.value.y=0,j.fresnelMaterial.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),A.rotateY(U)}function G(e){requestAnimationFrame(G),W(e*.001),B.update(),D.render(R,O)}G();