import{C as e,G as t,I as n,L as r,Q as i,R as a,U as o,V as s,Z as c,et as l,i as u,ot as d,t as f,tt as p}from"../assets/OrbitControls-By_4D4Wy.js";import{t as m}from"../assets/fresnel_fragment_shader-rKZmwurF.js";var h=`varying vec2 vUv;
...
}`,y=`/helion/assets/Solarsystemscope_texture_2k_earth_daymap-DKLT2WuX.jpg`,b=`/helion/assets/Solarsystemscope_texture_2k_earth_nightmap-BBH1PX2h.jpg`,x=`/helion/assets/earthspec1k-DVJhpabx.jpg`,S=`/helion/assets/Earth-clouds-VLfYlTHa.png`,C=`/helion/assets/2k_earth_normal_map-F-0Z3WD3.png`,w=`/helion/assets/moonmap1k-DNk7Ihgk.jpg`,T=document.getElementById(`earthContainer`),E=document.createElement(`canvas`);E.class=`applicationCanvas`,T.appendChild(E);var D=new u({alpha:!0,canvas:E,antialias:!0});D.shadowMap.enabled=!0,D.shadowMap.type=1,D.setSize(T.clientWidth,T.clientHeight);var O=new o(75,T.clientWidth/T.clientHeight,.1,1e3);O.position.set(0,0,5);var k=new r({color:16755200,opacity:0,transparent:!0}),A=new n(new l(1,30,30),k),j=class t extends e{static loader=new p;static material=new i({uniforms:{u_dayTexture:{value:t.loader.load(y)},u_nightTexture:{value:t.loader.load(b)},u_normalTexture:{value:t.loader.load(C)},u_specTexture:{value:t.loader.load(x)},u_cloudTexture:{value:t.loader.load(S)},u_normalPower:{value:5},u_sunRelPosition:{value:new d(0,0,0)},u_position:{value:new d(0,0,0)},u_moonPosition:{value:new d(0,0,0)},u_moonRadius:{value:.05},u_sunRadius:{value:.2}},vertexShader:h,fragmentShader:g});static atmosphereMaterial=new i({uniforms:{u_sunRelPosition:{value:new d(0,0,0)},u_color:{value:new d(.45,.55,1)}},vertexShader:_,fragmentShader:v,transparent:!0,side:1,depthTest:!0,depthWrite:!1});static fresnelMaterial=new i({uniforms:{u_sunRelPosition:{value:new d(0,0,0)},u_color:{value:new d(.45,.55,1)}},vertexShader:_,fragmentShader:m,transparent:!0});constructor(){super();let e=new l(1,30,30);e.computeTangents();let r=new n(e,t.material);r.scale.set(.2,.2,.2);let i=new n(e,t.atmosphereMaterial);i.scale.set(1.05,1.05,1.05);let a=new n(e,t.fresnelMaterial);a.scale.set(1.0001,1.0001,1.0001),r.add(i,a),this.add(r)}},M=new a,N=new n(new l(1,30,30),M);N.scale.set(.05,.05,.05),new p().load(w,e=>{M.map=e,M.needsUpdate=!0});var P=new t(16777215,15);P.position.set(0,0,0),P.castShadow=!0;var F=new s,I=new s,L=new s,R=new c,z=new j;R.add(z),R.add(A),A.add(P),R.add(F),F.add(I),I.add(L),L.add(N);var B=new f(O,E);B.enableDamping=!0,O.position.set(0,0,.6);var V=.5,H=0,U=0;function W(e){N.position.set(.4*Math.cos(V*e),0,-.4*Math.sin(V*e)),A.position.set(3*Math.cos(H*e),0,-3*Math.sin(H*e)),j.material.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.material.uniforms.u_sunRelPosition.value.y=0,j.material.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),j.material.uniforms.u_moonPosition.value.x=.4*Math.cos(V*e),j.material.uniforms.u_moonPosition.value.y=0,j.material.uniforms.u_moonPosition.value.z=-.4*Math.sin(V*e),j.atmosphereMaterial.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.atmosphereMaterial.uniforms.u_sunRelPosition.value.y=0,j.atmosphereMaterial.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),j.fresnelMaterial.uniforms.u_sunRelPosition.value.x=3*Math.cos(H*e),j.fresnelMaterial.uniforms.u_sunRelPosition.value.y=0,j.fresnelMaterial.uniforms.u_sunRelPosition.value.z=-3*Math.sin(H*e),A.rotateY(U)}function G(e){requestAnimationFrame(G),W(e*.001),B.update(),D.render(R,O)}G();