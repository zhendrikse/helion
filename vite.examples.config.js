    ...
    build: {
        ...
        rollupOptions: {
            input: {
                ...
                boltzmann_gas_2d: path.resolve(__dirname, 'examples/thermodynamics/scenes/boltzmann_gas_2d.js'),
                ...
                em_field_transform: path.resolve(__dirname, 'examples/relativity/scenes/em_field_transform.js'),
                ...
                lattice_boltzmann_2d: path.resolve(__dirname, 'examples/fluiddynamics/scenes/lattice_boltzmann_2d.js'),
                ...
                qmsolve_eigenstates: path.resolve(__dirname, 'examples/quantumphysics/scenes/qmsolve_eigenstates.js'),
                ...
                refraction: path.resolve(__dirname, 'examples/optics/scenes/refraction.js'),
                ...
                spherical_harmonics: path.resolve(__dirname, 'examples/mathematics/scenes/spherical_harmonics.js'),
