...
export class Binding {
    ...
    initialize() {
        if (!this.view.canBindTo(this.model)) throw new Error("Helion cannot bind this view to this model");
...
export class Simulation {
    ...
    constructor(viewport, renderer, headUpDisplay, infoPanel) {
        this._viewport = viewport; this._renderer = renderer; this._bindings = []; this._plot = null; this._hud = null; this._onReset = () => {}; this._status = Simulation.Status.STOPPED; this._axesUI = null;
        this._timeScale = 1; this._clock = new SimulationClock(); this._maxPerformanceFunction = null; this._iterationsPerFrame = 10; this._minimumFrameRate = 30; this._stepFunction = null; this._stepsPerClockTick = 1; this._onFrame = (time) => {}; this._lastTime = performance.now(); this._framesPerSecond = 0;
    ...
    start() { this._hud?.show("Running", 1000); this._status = Simulation.Status.RUNNING; return this; } stop() { this._hud?.show("Simulation stopped"); this._status = Simulation.Status.STOPPED; return this; } get isRunning() { return this._status === Simulation.Status.RUNNING; }
