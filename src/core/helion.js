...
export class Simulation {
     ...
     * equally fast on different hardware. Suppose the frame rate is 60 frames / sec. So, for example,
     ...
     * @param iterationsPerFrame The initial number of iterations per frame, that subsequently gets tuned every second!
     */
