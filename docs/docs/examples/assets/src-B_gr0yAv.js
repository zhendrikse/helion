...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $o(e,t,n){let r=new Float32Array(zo),i=new q(0,1,0);return new ga({name:`SphericalGaussianBlur`,defines:{n:zo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function es(){return new ga({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ns(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ts(){return new ga({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ns(),fragmentShader:`
	...
	`}var rs=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new wi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Oc={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function kc(e,t){let n=Oc[t];return n===void 0?(H(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ac=new q;function jc(){return Y.getLuminanceCoefficients(Ac),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ac.x.toFixed(4)}, ${Ac.y.toFixed(4)}, ${Ac.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            `}))}#t(e){let t=[{count:250,size:2,color:5592405},{count:1500,size:1,color:3355443}],n=[];for(let r=0;r<t.length;r++){let{count:i,size:a,color:o}=t[r],s=new Float32Array(i*3);for(let t=0;t<i;t++){let n=new q(Math.random()*2-1,Math.random()*2-1,Math.random()*2-1).normalize().multiplyScalar(e);s[3*t+0]=n.x,s[3*t+1]=n.y,s[3*t+2]=n.z}let c=new Er;c.setAttribute(`position`,new dr(s,3));let l=new _i({color:o,size:a,sizeAttenuation:!1,depthWrite:!1,depthTest:!1});for(let e=10;e<30;e++){let e=new Si(c,l);e.rotation.set(Math.random()*Math.PI,Math.random()*Math.PI,Math.random()*Math.PI),e.updateMatrix(),e.matrixAutoUpdate=!1,n.push(e.clone())}}return n}update(e,t){this.quaternion.copy(t.quaternion),this._glowStars.material.uniforms.uTime.value=e*.001,this.position.copy(t.position)}};export{Tt as A,Hl as C,Ti as D,Er as E,_i as M,K as N,X as O,q as P,Wl as S,dr as T,Ql as _,Gu as a,tu as b,Iu as c,cu as d,su as f,fu as g,uu as h,qu as i,Si as j,Cn as k,Ru as l,ou as m,Uu as n,zu as o,iu as p,Hu as r,Fu as s,Vu as t,au as u,eu as v,Kl as w,$l as x,ru as y};