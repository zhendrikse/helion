---
title: "λ Fraunhofer diffraction"
...
<div id="fraunhoferCanvasWrapper" class="canvasWrapper">
    <canvas id="fraunhoferCanvas" class="applicationCanvas"></canvas>
</div>
...
<div class="buttonRow">
    <label for="wavelengthSlider">Color:</label>
    ...
    <label for="laserColor">🎨 </label><input type="checkbox" id="laserColor" checked/>
</div>
