...
<div class="badgeRow">
    <a href="https://github.com/zhendrikse/helion/blob/main/examples/molecularphysics/scenes/rutherford_scattering.js">
        <img alt="Source" src="https://img.shields.io/badge/github-repo-green?logo=github&label=rutherford_scattering.js"/>
    </a>
</div>

🎯 Experiment that lead to the first model of the atom<br/>
🧠 Original [08_Rutherford_dist.py](https://lectdemo.github.io/virtual/scripts/08_Rutherford_dist.py) by Ruth Chabay Spring 2000<br/>
🐍 A [VPython demo](https://www.glowscript.org/#/user/zeger.hendrikse/folder/Electromagnetism/program/Rutherfordscattering) is available as well, see [rutherford_scattering.py](https://github.com/zhendrikse/physics-in-python/blob/main/vpython/rutherford_scattering.py)<br/>

<div id="rutherfordScatteringContainer"></div>
<script type="module" src={import.meta.env.BASE_URL + "examples/rutherford_scattering.js"}></script>
...
<figure style="text-align: center;">
    <img alt="Atom model history" src={import.meta.env.BASE_URL + "images/molecularphysics/atom_model_history.jpg"}/>
