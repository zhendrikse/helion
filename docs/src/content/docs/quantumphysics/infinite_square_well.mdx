...
📌 Analytic time evolution for a particle in a two-dimensional infinite square well.<br/>
📌 The well is represented by the stationary basis $\psi(n,m) = sin(n*\pi*x/L_x) sin(m*\pi*y/L_y)$.<br/>
📌 The wavefunction evolves by applying the corresponding phase factors.<br/>
