...
🎯 Build intuition for complex waves, phase propagation, and the role of $k$ and $\omega$ <br/>
...
<div class="badgeRow">
    <a href="https://github.com/zhendrikse/helion/blob/main/examples/quantumphysics/scenes/plane_wave.js">
        <img alt="Source" src="https://img.shields.io/badge/github-repo-green?logo=github&label=plane_wave.js"/>
    </a>
</div>
...
<script type="module" src={import.meta.env.BASE_URL + "examples/plane_wave.js"}></script>
<p style="clear: both;"></p>
...
> A plane wave does **not** represent a localized particle,
> but a state with definite momentum and completely delocalized position.
...
$$\begin\{equation\}
p = \dfrac\{h\}\{\lambda\} = \dfrac\{h\}\{2\pi\} \dfrac\{2\pi\}\{\lambda\} =
\hbar k \Rightarrow \hbar k =
\hbar \dfrac\{\partial\}\{\partial x\} \psi(x,t) =
p \psi(x, t) \Rightarrow p = \hbar \dfrac\{\partial\}\{\partial x\}
\end\{equation\}$$
...
$$\begin\{equation\}
E = hf = \dfrac\{h\}\{2\pi\}\dfrac\{2\pi\}\{T\} =
\hbar \omega \Rightarrow -i\hbar\dfrac\{\partial\}\{\partial t\} \psi(x,t) =
E \psi(x,t) \Rightarrow E = -i\hbar\dfrac\{\partial\}\{\partial t\}
\end\{equation\}$$
