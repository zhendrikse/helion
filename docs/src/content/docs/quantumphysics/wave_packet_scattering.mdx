...
<div class="badgeRow">
    <a href="https://github.com/zhendrikse/helion/blob/main/examples/quantumphysics/scenes/quantum_wave_scattering.js">
        <img alt="Source" src="https://img.shields.io/badge/github-repo-green?logo=github&label=quantum_wave_scattering.js"/>
    </a>
</div>
...
<div id="quantumScattering" style="aspect-ratio: 19/12"></div>
<script type="module" src={import.meta.env.BASE_URL + "examples/quantum_wave_scattering.js"}></script>
<p style="clear: both;"></p>
