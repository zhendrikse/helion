---
title: "Schwarzschild space-time ❍"
...
👉 The closer to the sun, the greater the difference between <span style="color: red">red</span> and <span style="color: orange">orange</span>!<br/>
🐍 A 3D [VPython demo](https://www.glowscript.org/#/user/zeger.hendrikse/folder/Relativity/program/SchwarzwschildSpaceTime) is available as well, see [schwarzschild_space_time.py](https://github.com/zhendrikse/physics-in-python/blob/main/vpython/schwarzschild_space_time.py)<br/>
