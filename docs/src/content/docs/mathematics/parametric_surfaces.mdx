...
<div class="canvasWrapper" id="parametricSurfacesCanvasWrapper">
    ...
    <select name="scalarFieldSelect" id="scalarFieldSelect">
        <option value="GaussianCurvature">Gaussian curvature</option>
        <option value="MeanCurvature">Mean curvature</option>
        <option value="PrincipalCurvature1">Principal curvature 1</option>
        <option value="PrincipalCurvature2">Principal curvature 2</option>
        <option value="ShapeIndex">Shape index field</option>
