...
🎯 Illustration of visualizing parametric surfaces with [Helion](https://www.hendrikse.name/helion/)<br/>

$$
\phi(u, v): \mathbb{R}^2 \rightarrow \mathbb{R}^3
$$

<div id="parametricSurfacesContainer"></div>
...
<div class="badgeRow">
    <a href="https://github.com/zhendrikse/helion/blob/main/examples/mathematics/scenes/spherical_harmonics.js">
        <img alt="Source" src="https://img.shields.io/badge/github-repo-green?logo=github&label=spherical_harmonics.js"/>
    </a>
</div>

🎯 Illustration of visualizing parametric surfaces with [Helion](https://www.hendrikse.name/helion/)<br/>
👉 Formula is taken from [spherical harmonics](https://paulbourke.net/geometry/sphericalh/) by [Paul Bourke](https://paulbourke.net)

<div id="sphericalHarmonicsContainer"></div>
<script type="module" src={import.meta.env.BASE_URL + "examples/spherical_harmonics.js"}></script>
