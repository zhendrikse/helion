...
<figure style="margin: 0 auto; text-align: center;">
  <a href="https://en.wikipedia.org/wiki/Chaos_game#/media/File:Sierpinski_Chaos.gif">
    <img alt="Sierpinksy chaos" src={import.meta.env.BASE_URL + "images/mathematics/Sierpinski_Chaos.gif"} style="width: 50%;"/>
  </a>
  <figcaption>
...
<figure style="margin: 0 auto; text-align: center;">
  <a href="https://math.bu.edu/DYSYS/chaos-game/node3.html">
    <img alt="Sierpinksy chaos" src={import.meta.env.BASE_URL + "images/mathematics/sierpinski.gif"}/>
  </a>
  <figcaption>
...
[strange attractor](https://www.hendrikse.name/helion/mathematics/strange_attractors/)!
