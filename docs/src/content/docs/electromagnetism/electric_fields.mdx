...
<div class="badgeRow">
    <a href="https://github.com/zhendrikse/helion/blob/main/examples/electromagnetism/scenes/non_ideal_capacitor.js">
        <img alt="Source" src="https://img.shields.io/badge/github-repo-green?logo=github&label=non_ideal_capacitor.js"/>
    </a>
</div>
...
<script type="module" src={import.meta.env.BASE_URL + "examples/non_ideal_capacitor.js"}></script>
<p style="clear: both;"></p>
