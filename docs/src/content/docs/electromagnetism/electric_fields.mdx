...
<div class="canvasWrapper" id="dipoleCanvasWrapper">
...
<div class="buttonRow">
    ...
    <label for="autoRotateDipole">Rotate </label>
    <input type="checkbox" id="autoRotateDipole"/>
</div>
...
<div class="canvasWrapper" id="solenoidCanvasWrapper">
...
<div class="buttonRow">
    ...
    <label for="autoRotateSolenoid">Auto-rotate </label><input type="checkbox" id="autoRotateSolenoid"/>
</div>
