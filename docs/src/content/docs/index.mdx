...
operators[^3], and numerical solvers [^4].
...
[^4]: Numeric solvers [demo 1](https://www.hendrikse.name/helion/mathematics/fourier_transform/) and
[demo 2](https://www.hendrikse.name/helion/nature/raindrops/)
